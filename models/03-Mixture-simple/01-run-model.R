...
jagsui <- jags(data = datlist,
               inits = initslist,
               model.file = ifelse(fixed_w==T, "models/03-Mixture-simple/Mixture_model_fixed_w.R", "models/03-Mixture-simple/Mixture_model.R"),
...
# set fixed_w to T or F depending on which mixture model we want to run
